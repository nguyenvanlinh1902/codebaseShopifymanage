...
import policyTemplateRoutes from './routes/policy-template-routes.js';
...
import shopifyProductRoutes from './routes/shopify-product-routes.js';
...
export const processProductImportQueue = onMessagePublished(
  {topic: 'product-import', memory: '2GiB', timeoutSeconds: 1800, retry: true},
  async event => {
