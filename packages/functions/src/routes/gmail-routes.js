...
import {
  ...
  getWatchStatus,
  startAllWatches
} from '../controllers/gmail/gmail-watch-handler.js';
import {
  getGmailAuthUrl, exchangeGmailCode, getGmailAccounts, disconnectGmailAccount, updateLinkedStores
...
router.post('/watch/start-all', startAllWatches);
